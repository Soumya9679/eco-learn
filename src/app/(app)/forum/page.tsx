      ...
      <motion.div variants={staggerItem} className="flex gap-2">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl text-sm text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-[var(--primary-500)]/30"
          ...
          <Card variant="glass" padding="lg">
            <form onSubmit={handleCreate} className="space-y-4">
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-2.5 rounded-xl text-sm text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-[var(--primary-500)]/30 resize-none"
                style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}
                required
              />
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl text-sm text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-[var(--primary-500)]/30"
                style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}
              />
              <div className="flex items-center justify-between">
                <button
                  ...
                  className="flex items-center gap-2 text-sm text-slate-400 hover:text-[var(--primary-400)] transition-colors cursor-pointer"
                >
                  <ImageIcon size={18} />
                    ...
                    <div className="flex items-center gap-4 mt-4 pt-3" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
                      <button
                        ...
                        className={`flex items-center gap-1.5 text-sm font-medium transition-colors cursor-pointer ${post.isPromotedByMe
                            ...
                            : "text-slate-500 hover:text-[var(--primary-400)]"
                          }`}
                      >
                        <ThumbsUp size={16} />
                        {post.promoteCount}
